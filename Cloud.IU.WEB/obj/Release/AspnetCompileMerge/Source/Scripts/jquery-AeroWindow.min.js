...
function rnd() {
    ...
    (function($) {
        var AeroWindowPlugin = function (element, top, left, options)
		{ // this create whole window 
            this.id = element;
            var elem = $("#" + element);
            ...
            WindowContainer.click(function () {// this function set focus on iframe when user click on window title
                WindowContent.find('iframe').focus();
            ...
            this.DesktopIconHandler = function() {
				...
				{ 
                    ...
                    } else if (settings.WindowStatus == 'window') 
					{
                        ...
                        var elm = WindowContent.find('iframe');
                        DoWork(options.WindowApplicationHandler,
                                options.WindowApplicationType,
                                elm);
            ...
            this.ResizeWindow = function(NewSize, FocusWindow, WindowStatusBefore) {
                ...
                switch (NewSize) {
                    ...
                    case 'minimize':
                        ...
                        if (navigator.appVersion.indexOf("MSIE") !== -1) { } else {
                            Window.animate({
                                opacity: 'hide'
                            }, {
                                queue: true,
                    ...
                    case 'restore':
                        ...
                        // this method call dowork method on desktop for run application and get required content back
                        //DoWork(options.WindowApplicationHandler,
                        //        options.WindowApplicationType,
                        //        elm);
            ...
            function init(id) 
			{// initial function for page Load . . . 
                ...
                if (settings.WindowDesktopIcon == true) 
				{
                    ...
                    $('#DesktopIcons').append('<div class="DesktopIconContainer" style="top:' + settings.IconTop + 'px;left:' + settings.IconLeft + 'px;position:absolute" id="DesktopIcon' + id + '">'
        ...
        AeroWindow = function(elem ,top , left, options) 
		{
            
                //var element = elem;
               
                var AeroWindow = new AeroWindowPlugin(elem,top , left , options);// in this class all behavious create
        ...
        AeroWindowLink = function(link , top , left) 
		{// create wiindow for displaying on desktop
            ...
            var options = $.extend({
                ...
                WindowAnimation: 'easeOutCubic',
                WindowTransparentAnimationSpeed: 300,
                WindowApplicationType: 0,
                WindowApplicationHandler:0
            }, options || {});
			/*
			...
			*/
			...
			var img = $("img", lnk).attr("src") ? $("img", lnk).attr("src") : ImagePath + '/icons/default.png';
                ...
                options.WindowDesktopIconFile = img;
                options.WindowStatus = "closed";
                options.WindowApplicationType = lnk.find("input[type='hidden']").val();
                options.WindowApplicationHandler = lnk.attr("href");
...
$(document).ready(function() {
    ...
    if ($('#Taskbar').length == 0) {
        ...
        $('#Taskbar').find("div#TaskbarShowDesktop").click(function () {
            transparentalloff();
            if (getOpenWindowsCount() > 0) {
                minall();
            } else {
        ...
        $('#Taskbar').find("div#TaskbarShowDesktop").on("mouseover mouseout", function (event) {
	...
	*/
    ...
    $('#Start-Menu-Button').on("click", function ()
    {
        ...
        window.location =  "/Start/Start_Screen/" + $("#sessionid").val() + "/" + $("#userid").val();
    });
