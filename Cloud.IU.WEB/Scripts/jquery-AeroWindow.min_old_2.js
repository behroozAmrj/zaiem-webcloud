...
/// <reference path='jquery-ui-1.8.1.custom.min.js' />
...
(function ($) {
    var AeroWindowPlugin = function (element, options) { // this create whole window 
        this.id = element;
        var elem = $("#" + element);
        ...
        this.TaskbarHandler = function () {
            $("#Taskbar" + this.id).on("mouseover mouseout", function (event) {
            ...
            $("#Taskbar" + this.id).on("click", function () {
        ...
        this.DesktopIconHandler = function () {
            $('#DesktopIcons .DesktopIconContainer').on("mouseover mouseout", function (event) {
                if (event.type == 'mouseover') {
            ...
            $('#DesktopIcon' + this.id).on("click", function () {
            ...
            $('#DesktopIcon' + this.id).dblclick(function (e) { // in this function when user dblClick icon on desktop tis method runs
                ...
                if (settings.WindowStatus == 'minimized') {
                    ...
                    obj.ResizeWindow('restore'); // this  shows window on desktop
                ...
                case 'restore':
                    ...
                    */
                    ...
                    WindowContent.find('iframe').attr("src",
                                                    "http://localhost:5146/Application-Service/NotePad/layouts/NotePadpage.html");
                    $(".AeroWindow").css("background-image", "");
                    WindowContent.animate({
        ...
        function init(id) {// initial function for page Load . . . 
            ...
            if (settings.WindowDesktopIcon == true) {
                ...
                // in this section desktop icon will attache to desktop
                $('#DesktopIcons').append('<div class="DesktopIconContainer" id="DesktopIcon' + id + '">'
                                            + '<table cellpadding="0" cellspacing="0" border="0" title="'
                                            + settings.WindowTitle + '">' + '  <tr>'
                                            + '    <td class="bg-top"></td>' + '  </tr>' + '  <tr>'
                                            + '    <td class="bg-middle"><img src="' + settings.WindowDesktopIconFile
                                            + '" width="48" height="48"></td>' + '  </tr>'
                                            + '  <tr>'
                                            + '    <td class="bg-bg"><p>'
                                            + DesktopIconCaption + '</p></td>' + '  </tr>' + '  <tr>'
                                            + '    <td class="bg-bottom"></td>' + '  </tr>' + '</table>' + '</div>');
                $('#DesktopIcon' + id).draggable(
                {
                    helper: "original",
                    start: function () {
                        $('#DesktopIcons .Container').removeClass('mouseoverclicked');
                        $('#DesktopIcons .DesktopIconContainer').removeClass('mouseoverclickedmouseout');
                        $(this).addClass('mouseoverclicked');
                    }
                });
        ...
        init(this.id);//  this generate desktop 
    ...
    AeroWindow = function (elem, options) {

        //var element = elem;

        var AeroWindow = new AeroWindowPlugin(elem, options);// in this class all behavious create
        //element.data('AeroWindow', AeroWindow);
        AeroWindow.TaskbarHandler();
        AeroWindow.DesktopIconHandler();
        if (($('body').data('AeroWindows')) == null) {
            $('body').data('AeroWindows', [AeroWindow]);// create data array and push it into it
        } else {
            $('body').data('AeroWindows').push(AeroWindow); // push aeroWindow into data array
        }

    };
    AeroWindowLink = function (link) {// create wiindow for displaying on desktop
        ...
        */
        var lnk = $(link);
        var img = $("img", lnk).attr("src") ? $("img", lnk).attr("src") : ImagePath + '/icons/default.png';
        var id = "-window_" + rnd();
        // in this section icon attach to desktop 


        $('body').append('<div id="' + id
                            + '" style="display: none;">'
                            + '<iframe src="" width="100%" height="100%" style="display:none; border: 0px;" frameborder="0" id="'
                            + id + '-iframe"></iframe>'
                            + '</div>');

        options.WindowURL = lnk.attr("href");
        options.WindowTitle = lnk.text();
        options.WindowDesktopIconFile = img;
        options.WindowStatus = "closed";
        // and by this generates window 
        //$("#" + id).AeroWindow(options);
        AeroWindow(id,
                    options);
...
$(document).ready(function () {
    ...
    $('#TaskbarShowDesktop').on("mouseover mouseout", function (event) {
        if (event.type == 'mouseover') {
            $(this).addClass('hover');
            transparentallon();
        } else {
    ...
    $('#TaskbarShowDesktop').on("click", function () {
        transparentalloff();
     ...
     */
    $('#Start-Menu-Button').on("mouseover mouseout", function (event) {
        if (event.type == 'mouseover')
            $(this).addClass('hover');
        else
            $(this).removeClass('hover');
    ...
    $('#Start-Menu #NavItems li').on("mouseover mouseout", function (event) {
        if (event.type == 'mouseover')
            $(this).addClass('hover');
        else
            $(this).removeClass('hover');
