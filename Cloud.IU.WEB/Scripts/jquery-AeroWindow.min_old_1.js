    ...
    (function($) 
	{
        var AeroWindowPlugin = function(element, options) 
		{
            ...
            this.DesktopIconHandler = function() 
			{
				...
				{ // this fucntion operate run an application on desktop by dbclick
					...
					else if (settings.WindowStatus == 'closed') 
					{
                        if (settings.WindowURL && $("#" + obj.id + "-iframe") !== undefined) 
						{
							...
							{
                                $("#" + obj.id + "-iframe").css("display", "none").attr("src", settings.WindowURL);// here set src for window to display content of site
            ...
            function init(id) 
			{// in this function create any element of page such as icon on desktop
                ...
                if (settings.WindowDesktopIcon == true) {
                    ...
                    });// in this section javascript creates div for display icon on desktop 
                    $('#DesktopIcons').append('<div class="DesktopIconContainer" id="DesktopIcon' + id + '">' + 
												...
												'<td class="bg-top"></td>' + '  </tr>' + 
												'  <tr>' + '    <td class="bg-middle"><img src="' 
												+ settings.WindowDesktopIconFile + '" width="48" height="48"></td>' + '  </tr>' + '  <tr>' + '    <td class="bg-bg"><p>' + 													DesktopIconCaption + '</p></td>' + '  </tr>' + '  <tr>' + 
        ...
        AeroWindowLink = function() 
		{//this method prepaire a div for running applications
            var options = $.extend({
                WindowURL: null,
                WindowTitle: 'Windows for jQuery',
            ...
            return( this.each(function() 
			{
                ...
                var id = "window-" + rnd() +"test";
                $('body').append('<div id="' + id + '" style="display:block;">' +
...
// from here begin to catch event handler	
